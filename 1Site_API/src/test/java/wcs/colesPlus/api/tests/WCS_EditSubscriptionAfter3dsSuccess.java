...
public class WCS_EditSubscriptionAfter3dsSuccess extends Base_Class_API implements ITest {
	...
	public void validateGenericErrorCodes(String testname) {
		...
		restLibrary.addPathParameter(FunLibrary.excelData.get("PathParamKey3"),
				FunLibrary.excelData.get("PathParamValue3"));
	...
	public void validate3DsSuccess() {
		...
		//Call Initiate Edit subscription API
			    response = APILibrary.editSubscription_WCS("", "", "",
				FunLibrary.excelData.get("Header1_Value"), FunLibrary.excelData.get("Header2_Value"), 
				FunLibrary.excelData.get("PathParamValue1"), FunLibrary.excelData.get("PathParamValue2"), 
				"Card", identifier);
			...
			response = APILibrary.initiate3Ds_WCS("", "", "",
					FunLibrary.excelData.get("Header1_Value"), FunLibrary.excelData.get("Header2_Value"), 
					FunLibrary.excelData.get("PathParamValue1"), recurringOrderId);
			funLibrary.validateStatusCode(response, FunLibrary.excelData.get("StatusCode"));
			
			//Call Proceed 3ds API
			response = APILibrary.proceed3Ds_WCS("", "", "",
					FunLibrary.excelData.get("Header1_Value"), FunLibrary.excelData.get("Header2_Value"), 
					FunLibrary.excelData.get("PathParamValue1"), recurringOrderId);
			funLibrary.validateStatusCode(response, FunLibrary.excelData.get("StatusCode"));
			
			//Call Final 3ds API
			response = APILibrary.final3Ds_WCS("", "", "",
					FunLibrary.excelData.get("Header1_Value"), FunLibrary.excelData.get("Header2_Value"), 
					FunLibrary.excelData.get("PathParamValue1"), recurringOrderId);
			funLibrary.validateStatusCode(response, FunLibrary.excelData.get("StatusCode1"));
			
			//Call Complete edit subscription API
			response = APILibrary.editSubscriptionComplete_WCS("", "", "",
					FunLibrary.excelData.get("Header1_Value"), FunLibrary.excelData.get("Header2_Value"), 
					FunLibrary.excelData.get("PathParamValue1"), FunLibrary.excelData.get("PathParamValue2"),
					recurringOrderId);
