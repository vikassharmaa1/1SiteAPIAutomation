...
public class WCS_ColesPlusMediumWeight extends Base_Class_API implements ITest {
	...
	@Test( description = "AC08- mandatoryParameterMissing")
	...
	public void wrongMethodOperation() {
		...
		RestLibrary restLibrary = new RestLibrary(Base_Class_API.BaseURI,
				...
				funLibrary.validateStatusCode(response, FunLibrary.excelData.get("StatusCode"));
				funLibrary.validateJSONPathValue_Equals(response, "reasonCode", FunLibrary.excelData.get("ReasonCode"));
				funLibrary.validateJSONPathValue_Equals(response, "description",
						FunLibrary.excelData.get("Description"));
				funLibrary.Assert.assertAll();
				}
