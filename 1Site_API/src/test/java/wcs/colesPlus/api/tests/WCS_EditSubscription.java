...
public class WCS_EditSubscription extends Base_Class_API implements ITest{
	...
	@Test(description = "AC01 & AC02- Verify edit subscription details based on the value set for 3DS enabled")
	public void validateEditSubDetails() {
		...
		case "new_cards":
			...
			if(ThreeDS_Value.contentEquals("new_cards") && FunLibrary.excelData.get("CardType_SavedCard").equalsIgnoreCase("SavedCard")) {
				...
				restLibrary.addPathParameter(FunLibrary.excelData.get("PathParamKey1"), FunLibrary.excelData.get("PathParamValue1"));
				restLibrary.addPathParameter(FunLibrary.excelData.get("PathParamKey2"), FunLibrary.excelData.get("PathParamValue2"));
				restLibrary.addBody(APILibrary.insertIdentifierSavedCard_WCS(FunLibrary.excelData.get("CardType_SavedCard")));
				Response response = restLibrary.executeAPI();
				restLibrary.getResponseBody(response);
				funLibrary.validateStatusCode(response, FunLibrary.excelData.get("StatusCode"));				
