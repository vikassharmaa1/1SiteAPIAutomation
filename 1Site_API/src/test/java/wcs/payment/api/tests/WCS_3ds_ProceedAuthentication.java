...
public class WCS_3ds_ProceedAuthentication extends Base_Class_API implements ITest {
	
	@Test( priority=1, description = "Initiate3DsSuccess")
	public void Initiate3DsSuccess() {
	...
	@Test( priority=2, description = "Proceed3DsSuccess")
	public void proceed3DsSuccess() {
