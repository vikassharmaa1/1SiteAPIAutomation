...
public class WCS_OrderProcessEnhancement extends Base_Class_API implements ITest {
	...
	public void validatePromoNotQualified() {
		...
		RestLibrary restLibrary = new RestLibrary(Base_Class_API.BaseURI,
				...
				// Verify qualified is set as false in response  
				if (response.jsonPath().getJsonObject("appliedPromoCodes") != null) {
	...
	public void validateExpiredPromoCode() {
		...
		RestLibrary restLibrary = new RestLibrary(Base_Class_API.BaseURI,
				...
				//Get the required path of each field
				String jsonId = jsonPathId.getString("appliedPromoCodes");
				String qualified = jsonPathId.getString("appliedPromoCodes[0].qualified");
				String savingAmount = jsonPathId.getString("appliedPromoCodes[0].savingAmount");
				String ActiveStatus = jsonPathId.getString("appliedPromoCodes[0].active");
