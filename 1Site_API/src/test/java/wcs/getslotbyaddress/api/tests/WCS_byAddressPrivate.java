package wcs.getslotbyaddress.api.tests;
...
public class WCS_byAddressPrivate extends Base_Class_API implements ITest {
	...
	@Test(dependsOnMethods = { "slotIdGet" }, description = "AC03- Verify slot Id is reserved")
	public void validateReservedSlotId() {
		...
		Payload.slotreservationAddress_WCS(FunLibrary.excelData.get("Header1_Value"),
				FunLibrary.excelData.get("Header2_Value"), FunLibrary.excelData.get("PathParamValue1"), jsonId);
		RestLibrary restLibrary = new RestLibrary(Base_Class_API.BaseURI,
				FunLibrary.excelData.get("BasePath"), FunLibrary.excelData.get("RequestType"));
		restLibrary.addHeader(FunLibrary.excelData.get("Header1_Key"), FunLibrary.excelData.get("Header1_Value"));
		restLibrary.addHeader(FunLibrary.excelData.get("Header2_Key"), FunLibrary.excelData.get("Header2_Value"));
	...
	@Test(description = "AC06- Verify incorrect length of postcode")
	...
	/*@Test(description = "AC08- Verify error code COLRS-ERR-BAD-REQ-004 when State value is incorrect")
	...
	public void validateMovFreeShipChargeColesPlusMember() {
		...
		DatabaseUtilities dbUtil = new DatabaseUtilities("SIT");
		String movFreeShipChargeDbColesPlus = dbUtil.getValues("x_coles_config", "VALUE",
				"name='colrs.ecomm.colesplus.HD.qualifiedamount'");
		String movFreeShipChargeDbNonColesPlus = dbUtil.getValues("x_coles_config", "VALUE",
				"name='colrs.ecomm.non.colesplus.HD.qualifiedamount'");
    ...
    public void validateBaggingOption_Normal() {
           ...
           List <String> Id=dbUtil.getMultipleValuesList("delwindow", "ID",
   				"status = 'OPEN' and " + "window_start_time like '%" + date + "%' and " + "window_end_time like '%"
   						+ date + "%' and DELZONE_NAME = '0404HD' and PARTNER_ID NOT IN ('BG01') and SERVICE_TYPE='HD'");
           ...
           String baggingOption = dbUtil.getValues("delsubzone", "HD_BAGGING_OPTIONS", 
        		   "suburb_id='10803' and delzone_name='0404HD'");
	...
	/*//@Test(description = "ST-4794 AC01- Verify bagging options")
    public void validateBaggingOption_PD() {
           ...
           List<String> Id = dbUtil.getMultipleValuesList("delwindow", "ID",
   				"status = 'OPEN' and " + "window_start_time like '%" + date + "%' and " + "window_end_time like '%"
   						+ date + "%' and DELZONE_NAME = '0404PD' and PARTNER_ID NOT IN ('BG01') and SERVICE_TYPE='HD'");
           ...
           String baggingOption = dbUtil.getValues("delsubzone", "HD_BAGGING_OPTIONS", 
        		   "suburb_id='10803' and delzone_name='0404PD'");
