...
public class APIM_GetSlotsByLocationPrivate extends Base_Class_API implements ITest{
	...
	public void validateMovFreeShipChargeColesPlusMember() {
		...
		System.out.println(isColesPlusMember);
	...
	public void validateReservedSlotId() {
		...
		//Payload.localizationByCollection(FunLibrary.excelData.get("AccessToken"), FunLibrary.excelData.get("UserJWT"), FunLibrary.excelData.get("StoreId"), FunLibrary.excelData.get("PathParamValue2"));
		 
		Payload.slotreservation_APIM(FunLibrary.excelData.get("Header1_Value"), FunLibrary.excelData.get("Header2_Value"), FunLibrary.excelData.get("Header3_Value"), jsonId);
