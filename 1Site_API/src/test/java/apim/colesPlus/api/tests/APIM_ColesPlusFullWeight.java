...
public class APIM_ColesPlusFullWeight extends Base_Class_API implements ITest{
	...
	public void validateGenericErrorCodes(String testname) {
			...
			if(!(FunLibrary.excelData.get("QueryParamKey3").equals(""))) {
				restLibrary.addQueryParameter(FunLibrary.excelData.get("QueryParamKey3"), FunLibrary.excelData.get("QueryParamvalue3"));
			}
			restLibrary.addQueryParameter(FunLibrary.excelData.get("QueryParamKey4"), FunLibrary.excelData.get("QueryParamvalue4"));
			restLibrary.addQueryParameter(FunLibrary.excelData.get("QueryParamKey5"), FunLibrary.excelData.get("QueryParamvalue5"));
	...
	public void validateDetailsColesPlusActiveUser() {
		...
		RestLibrary restLibrary = new RestLibrary(Base_Class_API.BaseURI,
				...
				if (moneySavedWithOnlineOrdersDB.contains("No Record Found") && moneySavedWithOnlineOrdersJson.contains("0")) {
				...
				if (timeSavedWithOnlineOrdersJson.contains("0") && timeSavedWithOnlineOrdersDB.contains("No Record Found")) {
