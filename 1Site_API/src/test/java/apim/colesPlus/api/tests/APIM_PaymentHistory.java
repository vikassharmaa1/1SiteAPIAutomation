...
public class APIM_PaymentHistory extends Base_Class_API implements ITest{
	...
	public void validateAccountDetailsColesPlusSubscription() {
		...
		String paymetnStatus_Db = dbUtil.getValues("orders", "STATUS", "orders_id='" + ChildOrderId_Db + "'");
		...
		String datePlaced_Db = funLibrary.storeDateBeforeWhitespace(dbUtil.getValues("orders", "TIMEPLACED", "orders_id='" + ChildOrderId_Db + "'"));
		...
		String lastUpdated_Db = funLibrary.storeDateBeforeWhitespace(dbUtil.getValues("orders", "LASTUPDATE", "orders_id='" + ChildOrderId_Db + "'"));
		...
		String fileName_Db = dbUtilCol.getValues("colinvoices", "FILENAME", "ORDER_ID='" + ChildOrderId_Db + "'");
		...
		String type_Db = dbUtilCol.getValues("colinvoices", "TYPE", "ORDER_ID='" + ChildOrderId_Db + "'");
