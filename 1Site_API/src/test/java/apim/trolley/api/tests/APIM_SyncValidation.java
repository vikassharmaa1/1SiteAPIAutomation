...
public class APIM_SyncValidation extends Base_Class_API implements ITest {
	...
	public void orderValidation_API() {
		...
		response = APILibrary.orderValidation_APIM(
	...
	public void validateSyncValidation() {
		...
		member_id = dbUtil.getValues("MBRATTRVAL", "MEMBER_ID", "MBRATTR_ID='1050' and STRINGVALUE='" +FunLibrary.excelData.get("CCP_ProfileID")+"'");
		orderId = dbUtil.getValues("ORDERS", "ORDERS_ID", "MEMBER_ID='" + member_id + "'");
	...
	public void validateValidPhoneNumber() {
		...
		case "206":	
			...
			funLibrary.validateJSONPathValue_Equals(response, "orderId", orderId);
			funLibrary.validateJSONPathValue_Equals(response, "orderValidationDetails.hasValidPhone","false");
	...
	public void validateSlotRestricted() {
		...
		case "206":	
			...
			funLibrary.validateJSONPathValue_Equals(response, "slotValidationDetails.actionRequiredOrderItems[0].validationDescription", "Due to its short shelf life, this item is not available for your selected time");
	...
	public void validLiquorExclusionOrder() {
		restLibrary = new RestLibrary();
		APILibrary.EmptyTrolley(FunLibrary.excelData.get("User"), FunLibrary.excelData.get("Header_userAuthorization"), FunLibrary.excelData.get("PathParam_storeId"));
		
		APILibrary.addItem_APIM("", "","",FunLibrary.excelData.get("Header_authorization"), FunLibrary.excelData.get("Header_userAuthorization"), FunLibrary.excelData.get("Header_subscriptionKey"),"0404","6593222", "2", "false");
