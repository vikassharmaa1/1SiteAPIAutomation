...
public class APIM_FullOrderSummary extends Base_Class_API implements ITest {
	...
	public void OrderFullSummaryAPI() {
		...
		storeId = FunLibrary.excelData.get("QueryParamValue1");
		...
		restLibrary.addQueryParameter(FunLibrary.excelData.get("QueryParamKey1"), storeId);
