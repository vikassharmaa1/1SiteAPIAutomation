package apim.enhanceProfileLookup.api.tests;
...
public class APIM_ProfileLookup extends Base_Class_API implements ITest {
	...
	public void verifyFlybuyNumberNotLinked() {
		...
		JsonPath jsonPath = response.jsonPath();
		String responseFlyBuyNumber = jsonPath.getString("contextAttribute[1].attributeValue.value");
		if (DB_FlyBuysNumber == null) {
			funLibrary.validate_Equals("FlyBuyNumber", null, responseFlyBuyNumber);
	...
	public void verifyProfileSubstitutionPreference() {
		...
		funLibrary.validate_Equals("ProfileSubstitutionPreference", DB_ProfileSubstitutionPreference,
				responseProfileSubstitutionPreference);
	...
	public void verifyuserisB2B() {
		...
		funLibrary.validate_Equals("BaggingPreference", "true", responseB2BUser);
	...
	public void verifyUserisnotB2B() {
		...
		JsonPath jsonPath = response.jsonPath();
		String responseB2BUser = jsonPath.getString("contextAttribute[5].attributeValue.value");
		funLibrary.validate_Equals("BaggingPreference", "false", responseB2BUser);
	...
	public void verifyUserisAdmin() {
		...
		funLibrary.validate_Equals("BaggingPreference", "true", responseAdmin);
	...
	public void verifyUserisnotAdmin() {
		...
		JsonPath jsonPath = response.jsonPath();
		String responseAdmin = jsonPath.getString("contextAttribute[7].attributeValue.value");
		funLibrary.validate_Equals("BaggingPreference", "false", responseAdmin);
