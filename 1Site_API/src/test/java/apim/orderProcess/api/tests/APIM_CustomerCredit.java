...
public class APIM_CustomerCredit extends Base_Class_API implements ITest {
	...
	public void validateCreditWhenTrollyModified() {
		...
		APILibrary.updateItem_APIM(Base_Class_API.BaseURI, FunLibrary.excelData.get("BasePath1"), 
		FunLibrary.excelData.get("RequestType1"), FunLibrary.excelData.get("Header1_Value"), 
		FunLibrary.excelData.get("Header2_Value"), FunLibrary.excelData.get("Header3_Value"),
