...
public class APIM_BaggingDetails extends Base_Class_API implements ITest {
	...
	public void validateOrderProcessforBetterbag() {
		...
		Response R = APILibrary.reserveSlot_APIM_1("", "", "", "0404", "1", slotId, "HD", "DM-SHIFT", "0404CC0404",
				ccpAddressId);

		Response orderprocess = APILibrary.orderProcessAPIM_1("", "", "",
