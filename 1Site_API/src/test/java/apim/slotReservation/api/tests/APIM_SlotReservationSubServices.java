...
public class APIM_SlotReservationSubServices extends Base_Class_API implements ITest {
	...
	public void subserviceMC() {
		...
		restLibrary.addBody(SlotReservationPayload.psReservationPayload(FunLibrary.excelData.get("storeId"), slotId,
				"CC", "123", FunLibrary.excelData.get("collectionPointId1")));
	...
	public void subserviceRD() {
		...
		restLibrary.addBody(SlotReservationPayload.psReservationPayload(FunLibrary.excelData.get("storeId"), slotId,
				"RD", "123", FunLibrary.excelData.get("collectionPointId1")));
