...
public class PS_SavePaymentMethodCard extends Base_Class_API implements ITest{
	...
	public void savePayment_Card_API() {
        ...
        response = APILibrary.savePaymentMethod_Card_PS(
	...
	public void paymentNameMissing() {
        ...
        response = APILibrary.savePaymentMethod_Card_PS(
                ...
                FunLibrary.excelData.get("QueryParam_ver"), null, null, null);        	
        // get the response body and print on console
        restLibrary.getResponseBody(response);
		funLibrary.validateStatusCode(response, FunLibrary.excelData.get("StatusCode"));
		funLibrary.validateJSONPathValue_Equals(response, "errors[0].errorCode", FunLibrary.excelData.get("ErrorCode"));
