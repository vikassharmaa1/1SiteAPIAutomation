...
public class PS_OrderProcessEnhancement extends Base_Class_API implements ITest {
	...
	public void validatePromoNotQualified() {
		...
		RestLibrary restLibrary = new RestLibrary(Base_Class_API.BaseURI,
				...
				if (response.jsonPath().getJsonObject("appliedPromoCodes") != null) {
					funLibrary.validate_Equals("appliedPromoCodes", jsonId, "[[qualified:false, savingAmount:0, active:true, promoCode:SHOPBACK10, promoCodeDescription:Thanks for shopping. Here's $10 off from promo code CLICK10!]]");
				}
	...
	/*@Test( description = "AC03- validatePromoNotQualified")
