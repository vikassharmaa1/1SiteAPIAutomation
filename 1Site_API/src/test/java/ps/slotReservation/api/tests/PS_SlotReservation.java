...
public class PS_SlotReservation extends Base_Class_API implements ITest {
...
*/
		...
		restLibrary.addHeader(FunLibrary.excelData.get("Header1_Key"), FunLibrary.excelData.get("Header1_Value"));
		restLibrary.addHeader(FunLibrary.excelData.get("Header2_Key"), FunLibrary.excelData.get("Header2_Value"));
		restLibrary.addBody(SlotReservationPayload.psReservationPayload(FunLibrary.excelData.get("storeId"),slotId, "RD", "123",FunLibrary.excelData.get("collectionPointId")));
		Response response = restLibrary.executeAPI();
		restLibrary.getResponseBody(response);
		funLibrary.validateStatusCode(response, FunLibrary.excelData.get("StatusCode"));
	...
	public void customermovRD() {
		...
		String slotId = dbUtil_DM.getValues("DELWINDOW", "ID",
				"WINDOW_START_TIME like '%" + funLibrary.getAnyDate(1, "yyyy-MM-dd")
						+ "%' and STATUS = 'OPEN' and COLLECTIONPOINT_NAME='"
						+ FunLibrary.excelData.get("collectionPointId")
						+ "'and service_type = 'RD' and COLLECTIONPOINT_NAME='"
						+ FunLibrary.excelData.get("collectionPointId")
...
/*
		...
		restLibrary.addHeader(FunLibrary.excelData.get("Header1_Key"), FunLibrary.excelData.get("Header1_Value"));
		restLibrary.addHeader(FunLibrary.excelData.get("Header2_Key"), FunLibrary.excelData.get("Header2_Value"));
		restLibrary.addBody(SlotReservationPayload.psReservationPayload(FunLibrary.excelData.get("storeId"),slotId, "CC", "123",FunLibrary.excelData.get("collectionPointId")));
		Response response = restLibrary.executeAPI();
		restLibrary.getResponseBody(response);
		funLibrary.validateStatusCode(response, FunLibrary.excelData.get("StatusCode"));
		JsonPath jsonPath = response.jsonPath();
...
/*
		...
		String slotId = dbUtil_DM.getValues("DELWINDOW", "ID",
				"WINDOW_START_TIME like '%" + funLibrary.getAnyDate(1, "yyyy-MM-dd")
						+ "%' and STATUS = 'OPEN' and COLLECTIONPOINT_NAME='"
						+ FunLibrary.excelData.get("collectionPointId")
						+ "'and service_type = 'CC' and COLLECTIONPOINT_NAME='"
						+ FunLibrary.excelData.get("collectionPointId")
						+ "' and minimum_order_value >1");
		dbUtil_DM.closeDBConnection();
		RestLibrary restLibrary = new RestLibrary(Base_Class_API.BaseURI,
				FunLibrary.excelData.get("BasePath"), FunLibrary.excelData.get("RequestType"));
		restLibrary.addHeader(FunLibrary.excelData.get("Header1_Key"), FunLibrary.excelData.get("Header1_Value"));
...
/*	@Test(description = "AC04- Verify error message if no ccpAddressId is passed")
	...
	public void validSlotDetailsUpateinDBHD() {
		...
		restLibrary.addHeader(FunLibrary.excelData.get("Header1_Key"), FunLibrary.excelData.get("Header1_Value"));
		restLibrary.addHeader(FunLibrary.excelData.get("Header2_Key"), FunLibrary.excelData.get("Header2_Value"));
		restLibrary.addBody(SlotReservationPayload.psReservationPayload(FunLibrary.excelData.get("storeId"),slotId, "HD", ccpAddressId,FunLibrary.excelData.get("collectionPointId")));
		Response response = restLibrary.executeAPI();
		restLibrary.getResponseBody(response);
		funLibrary.validateStatusCode(response, FunLibrary.excelData.get("StatusCode"));
		JsonPath jsonPath = response.jsonPath();
	...
	public void sitemovHD() {
		...
		System.out.println(" DBoverallMOV" + "" + DBoverallMOV);
		//Assert.assertEquals(responseoverallMOV, DBoverallMOV);
		funLibrary.validate_Contains("windowmovrd", DBoverallMOV,responseoverallMOV);
	...
	public void validatesforIncorrectccpAddressId() {
		...
		restLibrary.addHeader(FunLibrary.excelData.get("Header1_Key"), FunLibrary.excelData.get("Header1_Value"));
		restLibrary.addHeader(FunLibrary.excelData.get("Header2_Key"), FunLibrary.excelData.get("Header2_Value"));
		restLibrary.addBody(SlotReservationPayload.psReservationPayload( FunLibrary.excelData.get("storeId"),slotId, "HD", "rt600afc64-6f70-4c13-bae2-4c6a9ba42076",
				FunLibrary.excelData.get("collectionPointId")));
