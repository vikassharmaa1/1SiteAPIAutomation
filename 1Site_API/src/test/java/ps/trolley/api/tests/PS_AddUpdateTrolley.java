...
public class PS_AddUpdateTrolley extends Base_Class_API implements ITest {
	Response response = null;
	RestLibrary restLibrary = null;

	public void AddUpdateTrolley_API() {
		restLibrary = new RestLibrary();
		response = APILibrary.addUpdateTrolley_PS(Base_Class_API.BaseURI, FunLibrary.excelData.get("BasePath"), FunLibrary.excelData.get("RequestType"), FunLibrary.excelData.get("Header_Authorization"), FunLibrary.excelData.get("Header_UserAuthorization"),
	...
	public void updateItem(String partNumber, String orderItemId, String qty, String additionFields) {
		...
		response = APILibrary.updateItem_PS(Base_Class_API.BaseURI, FunLibrary.excelData.get("BasePath"), FunLibrary.excelData.get("RequestType"), FunLibrary.excelData.get("Header_Authorization"), FunLibrary.excelData.get("Header_UserAuthorization"), FunLibrary.excelData.get("StoreId"),
	...
	public void validateAddRemoveItems() {
		...
		String addressId = dbUtils.getValues("ADDRESS", "ADDRESS_ID", "MEMBER_ID = (select users_id from users where field1='" + FunLibrary.excelData.get("TestUser") + "') and ADDRESSTYPE='SB' and NICKNAME='Home' and STATUS='P'");
		...
		//Localising user using user address Id
		...
		// Adding items to cart // Getting data from data sheet e.g. partnumber, qty, tokens
		AddUpdateTrolley_API();
