...
public class PS_InitiateSubscription extends Base_Class_API implements ITest{
	...
	@Test(description = "AC02 & AC03- Verify initiate subscription details based on the value set for 3DS enabled with different version details")
