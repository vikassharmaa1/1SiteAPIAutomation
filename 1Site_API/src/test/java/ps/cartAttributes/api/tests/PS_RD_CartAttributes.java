package ps.cartAttributes.api.tests;
...
public class PS_RD_CartAttributes extends Base_Class_API implements ITest{
	...
	public void validateWhiteSpaceLessChars() {
		...
		response = PS.updateRDCustomerDetails("", "", "", authorization, userAuthorization, "0404", "1.1", "              ", "", "","1","1");
		DatabaseUtilities dbUtil = new DatabaseUtilities("SIT");
		String orderIdJson = funLibrary.getJsonPathValue(response, "orderId");
		String instructionsDB_Shipinfo = dbUtil.getValues("SHIPINFO", "INSTRUCTIONS", "ORDERS_ID = '" + orderIdJson + "'");
		String rdAddressIdDB = dbUtil.getValues("xorderattr", "Value", "ORDERS_ID = '" + orderIdJson + "' and NAME = 'rdAddressId'");
	...
	public void validateNewInstructionsOverwritten() {
		...
		String userAuthorization = FunLibrary.excelData.get("Header1_Value");
		Response response = null;
		response = PS.updateRDCustomerDetails("", "", "", authorization, userAuthorization, "0404", "1.1", ""+FunLibrary.excelData.get("DeliveryAdd1")+"", "", "","1","1");
		response = PS.updateRDCustomerDetails("", "", "", authorization, userAuthorization, "0404", "1.1", ""+FunLibrary.excelData.get("DeliveryAdd2")+"", ""+FunLibrary.excelData.get("Instructions")+"", ""+FunLibrary.excelData.get("Account")+"","1","1");
		DatabaseUtilities dbUtil = new DatabaseUtilities("SIT");
		String orderIdJson = funLibrary.getJsonPathValue(response, "orderId");
		String instructionsDB_Shipinfo = dbUtil.getValues("SHIPINFO", "INSTRUCTIONS", "ORDERS_ID = '" + orderIdJson + "'");
		String rdAddressIdDB = dbUtil.getValues("xorderattr", "Value", "ORDERS_ID = '" + orderIdJson + "' and NAME = 'rdAddressId'");
	...
	public void validateBlankAccountInstructions() {
		...
		String userAuthorization = FunLibrary.excelData.get("Header1_Value");
		Response response = null;
		response = PS.updateRDCustomerDetails("", "", "", authorization, userAuthorization, "0404", "1.1", ""+FunLibrary.excelData.get("DeliveryAdd1")+"", ""+FunLibrary.excelData.get("Instructions")+"", ""+FunLibrary.excelData.get("Account")+"","1","1");
		response = PS.updateRDCustomerDetails("", "", "", authorization, userAuthorization, "0404", "1.1", ""+FunLibrary.excelData.get("DeliveryAdd2")+"", "", "","1","1");
		DatabaseUtilities dbUtil = new DatabaseUtilities("SIT");
		String orderIdJson = funLibrary.getJsonPathValue(response, "orderId");
		String instructionsDB_Shipinfo = dbUtil.getValues("SHIPINFO", "INSTRUCTIONS", "ORDERS_ID = '" + orderIdJson + "'");
		String rdAddressIdDB = dbUtil.getValues("xorderattr", "Value", "ORDERS_ID = '" + orderIdJson + "' and NAME = 'rdAddressId'");
	...
	public void validateBlankInstructions() {
		...
		Response response = null;
		response = PS.updateRDCustomerDetails("", "", "", authorization, userAuthorization, "0404", "1.1", ""+FunLibrary.excelData.get("DeliveryAdd1")+"", ""+FunLibrary.excelData.get("Instructions")+"", ""+FunLibrary.excelData.get("Account")+"","1","1");
		response = PS.updateRDCustomerDetails("", "", "", authorization, userAuthorization, "0404", "1.1", ""+FunLibrary.excelData.get("DeliveryAdd2")+"", "", ""+FunLibrary.excelData.get("Account")+"","1","1");
		DatabaseUtilities dbUtil = new DatabaseUtilities("SIT");
		String orderIdJson = funLibrary.getJsonPathValue(response, "orderId");
		String instructionsDB_Shipinfo = dbUtil.getValues("SHIPINFO", "INSTRUCTIONS", "ORDERS_ID = '" + orderIdJson + "'");
		String rdAddressIdDB = dbUtil.getValues("xorderattr", "Value", "ORDERS_ID = '" + orderIdJson + "' and NAME = 'rdAddressId'");
	...
	public void validateBlankAccount() {
		...
		Response response = null;
		response = PS.updateRDCustomerDetails("", "", "", authorization, userAuthorization, "0404", "1.1", ""+FunLibrary.excelData.get("DeliveryAdd1")+"", ""+FunLibrary.excelData.get("Instructions")+"", ""+FunLibrary.excelData.get("Account")+"","1","1");
		response = PS.updateRDCustomerDetails("", "", "", authorization, userAuthorization, "0404", "1.1", ""+FunLibrary.excelData.get("DeliveryAdd2")+"", ""+FunLibrary.excelData.get("Instructions")+"", "","1","1");
		DatabaseUtilities dbUtil = new DatabaseUtilities("SIT");
		String orderIdJson = funLibrary.getJsonPathValue(response, "orderId");
		String instructionsDB_Shipinfo = dbUtil.getValues("SHIPINFO", "INSTRUCTIONS", "ORDERS_ID = '" + orderIdJson + "'");
		String rdAddressIdDB = dbUtil.getValues("xorderattr", "Value", "ORDERS_ID = '" + orderIdJson + "' and NAME = 'rdAddressId'");
	...
	public void validateBaggingAndUnattendedValues() {
		...
		Response response = null;
		response = PS.updateRDCustomerDetails("", "", "", authorization, userAuthorization, "0404", "1.1", ""+FunLibrary.excelData.get("DeliveryAdd1")+"", ""+FunLibrary.excelData.get("Instructions")+"", ""+FunLibrary.excelData.get("Account")+"","1","1");
		response = PS.updateRDCustomerDetails("", "", "", authorization, userAuthorization, "0404", "1.1", ""+FunLibrary.excelData.get("DeliveryAdd2")+"", "", ""+FunLibrary.excelData.get("Account")+"","2","2");
		DatabaseUtilities dbUtil = new DatabaseUtilities("SIT");
		String orderIdJson = funLibrary.getJsonPathValue(response, "orderId");
