package ps.promoCode.api.tests;
...
public class PS_RemovePromoCode extends Base_Class_API implements ITest {	
	Response response = null;
	RestLibrary restLibrary = null;

	public void ApplyPromoCode_API() {
		restLibrary = new RestLibrary();
		response = APILibrary.applyPromoCode_PS(
	...
	public void RemovePromoCode_API() {
		restLibrary = new RestLibrary();
		response = APILibrary.removePromoCode_PS(
				Base_Class_API.BaseURI, 
