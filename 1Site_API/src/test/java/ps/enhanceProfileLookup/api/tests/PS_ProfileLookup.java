package ps.enhanceProfileLookup.api.tests;
...
public class PS_ProfileLookup extends Base_Class_API implements ITest {
	...
	public void verifyUserisnotB2B() {
		...
		JsonPath jsonPath = response.jsonPath();
		String responseB2BUser = jsonPath.getString("contextAttribute[5].attributeValue.value");
		funLibrary.validate_Equals("b2buser", "false", responseB2BUser);
	...
	public void verifyUserisAdmin() {
		...
		funLibrary.validate_Equals("AdminUser", "true", responseAdmin);
	...
	public void verifyUserisnotAdmin() {
		...
		JsonPath jsonPath = response.jsonPath();
		String responseAdmin = jsonPath.getString("contextAttribute[7].attributeValue.value");
		funLibrary.validate_Equals("Adminuser", "false", responseAdmin);
	...
	public void verifyPostCodeandsuburb() {
		...
		funLibrary.validate_Equals("Suburb", "Bayview", Suburb);
