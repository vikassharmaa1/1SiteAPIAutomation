...
public class PS_GetSlotsByRDLocationPrivate extends Base_Class_API implements ITest{
	...
	public void validateremoteDeliveryPartnerDetails() {
		...
		response = PS.getSlotByRDLocationDate("", "", "", authorization, userAuthorization, "0404", "0404RD0002", date, date, "ALL");
		restLibrary.getResponseBody(response);
		funLibrary.validateStatusCode(response, FunLibrary.excelData.get("StatusCode"));
	...
	date = funLibrary.getDateAddDays(1);
		...
		String collectionPointId = FunLibrary.excelData.get("collectionPointId");
		Response response = null;
		response = PS.getSlotByRDLocationDate("", "", "", authorization, userAuthorization, storeId, collectionPointId, date, date, "ALL");
		restLibrary.getResponseBody(response);
		funLibrary.validateStatusCode(response, FunLibrary.excelData.get("StatusCode"));
