...
public class PS_GetSlotsByRDLocationPublic extends Base_Class_API implements ITest{
   ...
   @Test(dataProvider = "genericTestData", dataProviderClass = API_DataProvider.class)
	...
	public void validateremoteDeliveryPartnerDetails() {
		...
		response = PS.getSlotByRDLocationDatePublic("", "", "", authorization, storeId, collectionPointId, date, date, "ALL");
		restLibrary.getResponseBody(response);
		funLibrary.validateStatusCode(response, FunLibrary.excelData.get("StatusCode"));
