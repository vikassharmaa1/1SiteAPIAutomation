package ps.modifyOrder.api.tests;
...
public class PS_ModifyOrder  extends Base_Class_API implements ITest {
	Response response;
	...
	@Test(priority = 1, description = "AC01- Verify HD order gets modified")
	public void validateModifyOrder_HD() throws InterruptedException {
		...
		response=APILibrary.OrderFullWeightSummary_PS("", "", "", authorization, userAuthorization, "0404", "1.1");
		funLibrary.validateJSONPathValue_Equals(response, "orderAttributes.timeZone", "Australia/North");

		DatabaseUtilities dbUtil = new DatabaseUtilities("SIT");
		String db_order = dbUtil.getValues("orders", "ORDERS_ID","member_id = (select users_id from users where field1='" + FunLibrary.excelData.get("UserName")+ "') and STATUS='M'  order by LASTUPDATE asc" );
		System.out.println("id" + " " + db_order);
		response=APILibrary.modifyOrder_PS("", "", "", FunLibrary.excelData.get("Header_UserAuthorization"),FunLibrary.excelData.get("Header_Authorization"), "20503", "1",  db_order);
		funLibrary.validateStatusCode(response, FunLibrary.excelData.get("StatusCode"));
		funLibrary.validateJSONPathValue_Equals(response, "orderId", db_order);
		funLibrary.validateJSONPathValue_Equals(response, "timeZone", "Australia/North");

		 if(response.statusCode()==200)
			{
				response=APILibrary.modifyOrder_PS("", "", "", FunLibrary.excelData.get("Header_UserAuthorization"),
						FunLibrary.excelData.get("Header_Authorization"), "20503", "1",  db_order);				
				funLibrary.validateJSONPathValue_Equals(response, "errors[0].errorCode", FunLibrary.excelData.get("ErrorCode"));
				funLibrary.validateJSONPathValue_Equals(response, "errors[0].message",
						FunLibrary.excelData.get("ErrorMessage"));
				funLibrary.validateJSONPathValue_Equals(response, "errors[0].priority",
				...
				APILibrary.orderSubmit_PS_1("", "", "", "0404", authorization, userAuthorization, "", "","1.1");
				
			}
	}
	
	@Test(priority = 0, description = "AC01- Verify new attributes for medium weight summary")
	public void validateMediumweight() throws InterruptedException {
		 String authorization = FunLibrary.excelData.get("Header_Authorization");
			String userAuthorization = FunLibrary.excelData.get("Header_UserAuthorization");
		...
		System.out.println("id" + " " + db_order);
     response=APILibrary.OrderMediumWeightSummary_PS("", "", "", authorization, userAuthorization, "0404", "1.1");

		funLibrary.validateStatusCode(response, FunLibrary.excelData.get("StatusCode"));
		funLibrary.validateJSONPathValue_Equals(response, "orderModificationCount", "");
		funLibrary.validateJSONPathValue_Equals(response, "orderModifiedFlag", "false");	
			
	}
	@Test(priority = 2, description = "AC01- Verify new attributes for medium weight summary")
	public void validateMediumweight1() throws InterruptedException {
		String authorization = FunLibrary.excelData.get("Header_Authorization");
		String userAuthorization = FunLibrary.excelData.get("Header_UserAuthorization");
		DatabaseUtilities dbUtil = new DatabaseUtilities("SIT");
		String db_order = dbUtil.getValues("orders", "ORDERS_ID","member_id = (select users_id from users where field1='" + FunLibrary.excelData.get("UserName")+ "') and STATUS='M'  order by LASTUPDATE asc" );
		...
		String responseOrderId =jsonPath.getString("orderId");
		String DBModified = dbUtil.getValues("XORDERATTR", "VALUE","orders_id='" + responseOrderId + "' and NAME='OrderModificationCount'");
		funLibrary.validateJSONPathValue_Equals(response, "orderModificationCount", DBModified);
		funLibrary.validateJSONPathValue_Equals(response, "orderModifiedFlag", "true");	
		APILibrary.orderProcessPS_1("", "", "", "0404", authorization, userAuthorization, "1.1");
		APILibrary.orderSubmit_PS_1("", "", "", "0404", authorization, userAuthorization, "", "","1.1");	
		
	}
	
	@Test(priority = 3, description = "AC01- Verify order gets modified for CC Orders")
	public void validateOrderisModified_CC() throws InterruptedException {
		String authorization = FunLibrary.excelData.get("Header_Authorization");
		String userAuthorization = FunLibrary.excelData.get("Header_UserAuthorization");
		...
		response = PS.reserveSlot("", "", "", authorization, userAuthorization, "0404", slotId, "CC", "DM-SHIFT",
				"0404CC0404", ccpAddressId);
		...
		funLibrary.validate_Equals("db_status", db_order, "M");
		Thread.sleep(2000);
		response=APILibrary.modifyOrder_PS("", "", "", FunLibrary.excelData.get("Header_UserAuthorization"),
				FunLibrary.excelData.get("Header_Authorization"), "0404", "1",  orderId);		
		funLibrary.validateStatusCode(response, FunLibrary.excelData.get("StatusCode"));
		funLibrary.validateJSONPathValue_Equals(response, "orderId", orderId);
		 db_order = dbUtil.getValues("orders", "STATUS", "ORDERS_ID='" + orderId + "'");
		funLibrary.validate_Equals("db_status", db_order, "P");
		 if(response.statusCode()==200)
			{
				response=APILibrary.modifyOrder_PS("", "", "", FunLibrary.excelData.get("Header_UserAuthorization"),
						FunLibrary.excelData.get("Header_Authorization"), "0404", "1",  orderId);				
	...
	@Test(priority = 4,description = "validate schema of response json for CC orders")
	public void validateSchema_CC() {
		String authorization = FunLibrary.excelData.get("Header_Authorization");
		String userAuthorization = FunLibrary.excelData.get("Header_UserAuthorization");
		DatabaseUtilities dbUtil = new DatabaseUtilities("SIT");
		String db_order = dbUtil.getValues("orders", "ORDERS_ID","member_id = (select users_id from users where field1='" + FunLibrary.excelData.get("UserName")+ "') and STATUS='M'  order by LASTUPDATE asc" );
		System.out.println("id" + " " + db_order);
		response=APILibrary.modifyOrder_PS("", "", "", FunLibrary.excelData.get("Header_UserAuthorization"),
				FunLibrary.excelData.get("Header_Authorization"), "0404", "1",  db_order);
		funLibrary.validateJsonStructure(response, "modifyOrder_CC");
		if(response.statusCode()==200)
		{
			APILibrary.orderProcessPS_1("", "", "", "0404", authorization, userAuthorization, "1.1");
			APILibrary.orderSubmit_PS_1("", "", "", "0404", authorization, userAuthorization, "", "","1.1");
	...
	@Test(priority = 5,description = "validate schema of response json for HD orders")
	public void validateSchema_HD() {
		String authorization = FunLibrary.excelData.get("Header_Authorization");
		String userAuthorization = FunLibrary.excelData.get("Header_UserAuthorization");
		DatabaseUtilities dbUtil = new DatabaseUtilities("SIT");
		String db_order = dbUtil.getValues("orders", "ORDERS_ID","member_id = (select users_id from users where field1='" + FunLibrary.excelData.get("UserName")+ "') and STATUS='M'  order by LASTUPDATE asc" );
		...
		response=APILibrary.modifyOrder_PS("", "", "", FunLibrary.excelData.get("Header_UserAuthorization"),
				FunLibrary.excelData.get("Header_Authorization"), "20503", "1",  db_order);
		funLibrary.validateJsonStructure(response, "modifyOrder_HD");
		if(response.statusCode()==200)
		{
			APILibrary.orderProcessPS_1("", "", "", "0404", authorization, userAuthorization, "1.1");
			APILibrary.orderSubmit_PS_1("", "", "", "0404", authorization, userAuthorization, "", "","1.1");
	...
	@Test( description = "AC03- Verify that order cannot be cancelled cut off for cancelling the order is passed ")
	...
	@Test( description = "Verify invalid order status")
	...
	/*@Test(priority = -1, description = "AC01- Verify order gets modified CC to HD")
	public void validateModifyOrder_CCtoHD() throws InterruptedException {
		String authorization = FunLibrary.excelData.get("Header_Authorization");
		String userAuthorization = FunLibrary.excelData.get("Header_UserAuthorization");
		String storeId = FunLibrary.excelData.get("StoreIds");
		String ver = FunLibrary.excelData.get("ver");
		...
		String slotId1 = dbUtil_DM.getValues("DELWINDOW", "ID",
				"WINDOW_START_TIME like '%" + funLibrary.getAnyDate(1, "yyyy-MM-dd")
						+ "%' and STATUS = 'OPEN' and DELZONE_NAME = '" + FunLibrary.excelData.get("DELZONE_NAME")
						+ "' and service_type = 'HD'");
		System.out.println("slotid" + " " + FunLibrary.excelData.get("collectionPointId"));
		...
		DatabaseUtilities dbUtil = new DatabaseUtilities("SIT");
		APILibrary.addUpdateTrolley_PS_1("", "", "", authorization, userAuthorization, "5833943", "5");
		response = PS.reserveSlot("", "", "", authorization, userAuthorization, "0404", slotId, "CC", "DM-SHIFT","0404CC0404","1" );
		String identifier = APILibrary.getMPGSCardToken("4111111111111111", "12", "25", "123");
		RestAssured.reset();
		APILibrary.savePaymentMethod_Card_PS("", "", "", authorization, userAuthorization, "0404", "card", "true",identifier, "1");
		response = PS.cartAttribute("", "", "", authorization, userAuthorization, "20501", "2", "", "instruction", "");
		...
		funLibrary.validate_Equals("db_status", db_order, "M");
		Thread.sleep(10000);
		response=APILibrary.modifyOrder_PS("", "", "", FunLibrary.excelData.get("Header_UserAuthorization"),FunLibrary.excelData.get("Header_Authorization"), "0404", "1",  orderId);		
		funLibrary.validateStatusCode(response, FunLibrary.excelData.get("StatusCode"));
		funLibrary.validateJSONPathValue_Equals(response, "orderId", orderId);
		 db_order = dbUtil.getValues("orders", "STATUS", "ORDERS_ID='" + orderId + "'");
		funLibrary.validate_Equals("db_status", db_order, "P");
		dbUtil.closeDBConnection();
		//String ccpAddressId1 = funLibrary.getCCPAddressID(FunLibrary.excelData.get("UserName"),FunLibrary.excelData.get("NickName"));
		response = PS.reserveSlot("", "", "", authorization, userAuthorization, "0404", slotId1, "HD", "DM-SHIFT","0404CC0404", ccpAddressId);
		APILibrary.savePaymentMethod_Card_PS("", "", "", authorization, userAuthorization, "0404", "card", "true",identifier, "1");
		response = PS.cartAttribute("", "", "", authorization, userAuthorization, "20501", "2", "", "instruction", "");
		Thread.sleep(2000);
		APILibrary.orderProcessPS_1("", "", "", "0404", authorization, userAuthorization, "1.1");
		Response ordersubmit1 = APILibrary.orderSubmit_PS_1("", "", "", "20501", authorization, userAuthorization, "", "","1.1");
		JsonPath jsonPath1 = ordersubmit1.jsonPath();
		String orderId1 = jsonPath1.getString("orderId");
		System.out.println(orderId1);
		DatabaseUtilities dbUtil1 = new DatabaseUtilities("SIT");
		String db_order1 = dbUtil1.getValues("orders", "STATUS", "ORDERS_ID='" + orderId1 + "'");
		funLibrary.validate_Equals("db_status", db_order1, "M");
		response=APILibrary.modifyOrder_PS("", "", "", FunLibrary.excelData.get("Header_UserAuthorization"),
				FunLibrary.excelData.get("Header_Authorization"), "0404", "1",  orderId1);		
		funLibrary.validateStatusCode(response, FunLibrary.excelData.get("StatusCode"));
		funLibrary.validateJSONPathValue_Equals(response, "orderId", orderId1);
		 db_order1 = dbUtil1.getValues("orders", "STATUS", "ORDERS_ID='" + orderId1 + "'");
		funLibrary.validate_Equals("db_status", db_order1, "P");
	  Thread.sleep(10000);
	APILibrary.savePaymentMethod_Card_PS("", "", "", authorization, userAuthorization, "0404", "card", "true",identifier, "1");
	response = PS.cartAttribute("", "", "", authorization, userAuthorization, "20501", "2", "", "instruction", "");
		Thread.sleep(10000);
