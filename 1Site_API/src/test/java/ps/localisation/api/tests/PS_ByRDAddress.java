...
public class PS_ByRDAddress extends Base_Class_API implements ITest{
	
	
	@Test(dataProvider = "functionalTestData", dataProviderClass = API_DataProvider.class)
	public void validateFunctionalErrorCodes(String testname) {
		DatabaseUtilities dbUtil = new DatabaseUtilities();
		String ccpaddressid = dbUtil.getValues("xaddress", "CCPADDRESSID", "address_id in (select address_id from address where STATUS='P' and nickname='Address 1' and member_id=(select users_id from users where field1= 'localise.rd@getnada.com'))");
		String coladdressid = dbUtil.getValues("xaddress", "ADDRESS_ID", "address_id in (select address_id from address where STATUS='P' and nickname='Address 1' and member_id=(select users_id from users where field1= 'locaise.rd@getnada.com'))");
		String orderid= dbUtil.getValues("Orders", "orders_id", "member_id=(select users_id from users where field1= 'b2c.customer@getnada.com') and status='P'");
		...
		restLibrary.addBody(Payload.rdAddressPayload(FunLibrary.excelData.get("reqstoreid"), FunLibrary.excelData.get("reqsuburb"), FunLibrary.excelData.get("reqpostcode"), FunLibrary.excelData.get("reqcountry"), FunLibrary.excelData.get("reqverificationid"), ccpaddressid,FunLibrary.excelData.get("relongitude"),FunLibrary.excelData.get("relatitude")));
	...
	public void RDAddress_RDAddressIdCorrespondsToColAddressId() {
		DatabaseUtilities dbUtil = new DatabaseUtilities();
		String order_id= dbUtil.getValues("Orders", "orders_id", "member_id=(select users_id from users where field1= 'localise.rd@getnada.com') and status='P'");
		String ccpaddressid_db = dbUtil.getValues("xaddress", "CCPADDRESSID", "address_id in (select address_id from address where STATUS='P' and nickname='Address 1' and member_id=(select users_id from users where field1= 'localise.rd@getnada.com'))");
		String coladdressid_db = dbUtil.getValues("xaddress", "ADDRESS_ID", "address_id in (select address_id from address where STATUS='P' and nickname='Address 1' and member_id=(select users_id from users where field1= 'localise.rd@getnada.com'))");
		String validationid_db = dbUtil.getValues("xaddress", "VALIDATIONID", "address_id in (select address_id from address where STATUS='P' and nickname='Address 1' and member_id=(select users_id from users where field1= 'localise.rd@getnada.com'))");
		String longitude_db = dbUtil.getValues("xaddress", "LONGITUDE", "address_id in (select address_id from address where STATUS='P' and nickname='Address 1' and member_id=(select users_id from users where field1= 'localise.rd@getnada.com'))");
		String latitude_db = dbUtil.getValues("xaddress", "LATITUDE", "address_id in (select address_id from address where STATUS='P' and nickname='Address 1' and member_id=(select users_id from users where field1= 'localise.rd@getnada.com'))");
		String postcode_db=dbUtil.getValues("address","ZIPCODE","member_id=(select users_id from users where field1= 'localise.rd@getnada.com')and nickname='Address 1'");
		String country_db=dbUtil.getValues("address","COUNTRY","member_id=(select users_id from users where field1= 'localise.rd@getnada.com')and nickname='Address 1'");
		String suburb_db=dbUtil.getValues("address","CITY","member_id=(select users_id from users where field1= 'localise.rd@getnada.com')and nickname='Address 1'");
		String state_db=dbUtil.getValues("address","STATE","member_id=(select users_id from users where field1= 'localise.rd@getnada.com')and nickname='Address 1'");
		String servicetype_db=dbUtil.getValues("xorderattr","VALUE","orders_id=(select orders_id from orders\r\n" + 
				"where member_id=(select users_id from users where field1= 'localise.rd@getnada.com') \r\n" + 
	...
	public void validateGenericErrorCodes(String testname) {
		...
		restLibrary.addHeader(FunLibrary.excelData.get("Header1_Key"), FunLibrary.excelData.get("Header1_Value"));
		restLibrary.addHeader(FunLibrary.excelData.get("Header2_Key"), FunLibrary.excelData.get("Header2_Value"));
		restLibrary.addBody(Payload.rdAddressPayload(FunLibrary.excelData.get("reqstoreid"), FunLibrary.excelData.get("reqsuburb"), FunLibrary.excelData.get("reqpostcode"), FunLibrary.excelData.get("reqcountry"), FunLibrary.excelData.get("reqverificationid"), FunLibrary.excelData.get("ccpaddressid"),FunLibrary.excelData.get("relongitude"),FunLibrary.excelData.get("relatitude")));
